    ...
    <div className="senjr-app">
      ...
      <div className="senjr-page">
        ...
        <div className="senjr-content" style={{ marginTop: -24 }}>
          <div className="senjr-card senjr-fade-in" style={{ textAlign: 'center', marginBottom: 20, border: 'none' }}>
          ...
          <div className="senjr-card" style={{ marginBottom: 20, border: '1px solid var(--senjr-green-light)', background: 'var(--senjr-green-lighter)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
              <h2 className="senjr-section-title" style={{ fontSize: 18, marginBottom: 0 }}>My Journey</h2>
              <button className="senjr-btn-icon" style={{ width: 32, height: 32 }}><Share2 size={14} /></button>
            </div>
            <div className="senjr-grid-3" style={{ marginBottom: 16 }}>
              <div className="senjr-stat-card" style={{ background: 'var(--senjr-green-lighter)' }}>
              ...
              <div className="senjr-stat-card"><span className="senjr-stat-value" style={{ fontSize: 16 }}>{journey.sessions}</span><span className="senjr-stat-label">Sessions</span></div>
              <div className="senjr-stat-card"><span className="senjr-stat-value" style={{ fontSize: 16, color: 'var(--senjr-orange)' }}>{journey.hours}</span><span className="senjr-stat-label">Hours</span></div>
            </div>
            <div>
              ...
              <div className="senjr-progress-bar"><div className="senjr-progress-fill" style={{ width: `${(journey.xp / journey.xpMax) * 100}%`, background: 'var(--senjr-green-dark)' }} /></div>
            </div>
          </div>
          ...
          <div className="senjr-fade-in" style={{ marginBottom: 20 }}>
            ...
            <div className="senjr-grid-3" style={{ gap: 10 }}>
              {achievements.map((a, i) => {
                const Icon = a.icon
                return (
                  <div key={i} style={{ textAlign: 'center', padding: '14px 8px', borderRadius: 12, background: a.unlocked ? 'white' : 'var(--senjr-bg)', border: a.unlocked ? '1px solid var(--senjr-border)' : '1px dashed var(--senjr-border)', opacity: a.unlocked ? 1 : 0.6 }}>
                    <div style={{ width: 40, height: 40, borderRadius: '50%', background: a.unlocked ? `${a.color}20` : 'var(--senjr-border)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 6px' }}>
          ...
          <div className="senjr-fade-in" style={{ marginBottom: 20 }}>
            ...
            {recentActivity.map((activity, i) => {
              ...
              return (
                <div key={i} className="senjr-card" style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8, border: 'none' }}>
          ...
          <div className="senjr-fade-in" style={{ marginBottom: 100 }}>
            ...
            {menuItems.map((item, i) => {
              ...
              return (
                <button key={i} className="senjr-card" style={{ display: 'flex', alignItems: 'center', gap: 12, width: '100%', textAlign: 'left', marginBottom: 8, border: 'none', cursor: 'pointer' }}
