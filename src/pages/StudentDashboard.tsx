    ...
    <div className="senjr-app">
      <header className="senjr-header" style={{ background: 'var(--senjr-bg-card)', borderBottom: '1px solid var(--senjr-border)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div className="senjr-avatar" style={{ width: 32, height: 32, fontSize: 14, background: 'var(--senjr-green)', color: 'white' }}>{displayName.charAt(0)}</div>
        </div>
      </header>
      ...
      <div className="senjr-page">
        <div className="senjr-content">
          <div className="senjr-slide-up" style={{ marginBottom: 20 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <span style={{
                ...
                padding: '4px 10px', borderRadius: 'var(--senjr-radius-full)',
          ...
          <div className="senjr-card-green" style={{ marginBottom: 20 }}>
            ...
            <div className="senjr-progress-bar" style={{ background: 'rgba(255,255,255,0.6)' }}>
          ...
          <div className="senjr-grid-2" style={{ marginBottom: 20 }}>
            {quickActions.map((a, i) => {
              const Icon = a.icon
              return (
                <button key={a.label} className="senjr-card-flat" style={{
                  ...
                  <div style={{
                    ...
                    margin: '0 auto 8px', border: '1px solid var(--senjr-border)',
                  }}>
          ...
          <div className="senjr-card-orange" style={{ marginBottom: 20, position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="senjr-card" style={{ marginBottom: 20 }}>
            <div className="senjr-flex-between" style={{ marginBottom: 12 }}>
              ...
              <button className="senjr-btn senjr-btn-sm" style={{ background: 'var(--senjr-green)', color: 'white' }} onClick={() => navigate('/ai-tutor')}>
                Practice All
              </button>
            </div>
            {weakTopics.map((t, i) => (
          ...
          <div className="senjr-card" style={{ background: 'var(--senjr-orange-lighter)', marginBottom: 20 }}>
            ...
            {recommendedMentors.map((m) => (
              <button key={m.name} style={{
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <p style={{ fontSize: 12, color: 'var(--senjr-text-muted)' }}>{m.expertise} &middot; <Star size={10} style={{ display: 'inline', verticalAlign: 'middle', color: 'var(--senjr-orange)' }} /> {m.rating}</p>
                </div>
          ...
          <div className="senjr-card" style={{ marginBottom: 20 }}>
            ...
            {leaderboard.map((l) => (
              <div key={l.name} style={{
                ...
                border: l.isYou ? '1px solid var(--senjr-green)' : '1px solid var(--senjr-border)',
              }}>
